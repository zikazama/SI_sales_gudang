...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Agu 2020 pada 20.10
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `merek`, `harga`, `stok`, `diskon`, `minimal_kuantitas_diskon`, `foto`, `created_at`) VALUES
(2, 'Tas', 'gucci', 300000, 200, 10000, 5, 'fe390655d9710d87ecf83207e4d3c924.jpg', '2020-07-27 01:23:02'),
(3, 'Bahan', 'LG', 30000, 200, 0, 0, '2f5b1b913b2f3a286062c24d838717fa.jpg', '2020-07-27 01:22:58');
...
INSERT INTO `item_transaksi` (`id_item_transaksi`, `id_transaksi_sales`, `id_barang`, `kuantitas`, `subtotal`, `subdiskon`, `created_at`) VALUES
(8, 9, 2, 2, 600000, 0, '2020-06-14 18:37:50'),
(9, 10, 2, 5, 1500000, 10000, '2020-06-15 04:17:12'),
(10, 11, 2, 3, 900000, 0, '2020-06-25 10:45:55'),
(11, 12, 2, 3, 900000, 0, '2020-06-26 10:48:22'),
(12, 13, 3, 10, 300000, 6000, '2020-07-04 09:02:37'),
(13, 14, 3, 2, 60000, 0, '2020-07-04 09:05:05'),
(14, 15, 3, 5, 150000, 0, '2020-07-10 16:31:42'),
(15, 16, 2, 1, 300000, 0, '2020-07-22 11:06:18'),
(16, 17, 2, 1, 300000, 0, '2020-07-22 11:13:19');
...
--
ALTER TABLE `item_transaksi`
  MODIFY `id_item_transaksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `transaksi_sales`
  MODIFY `id_transaksi_sales` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
