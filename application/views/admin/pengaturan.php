                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="row">
                            <div class="col-xl">
                                ...
                                ?>
                                        <form method="POST" action="<?= base_url('admin/setting/aksi_ubah_password/').$this->session->userdata('id') ?>">
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="row">
                            <div class="col-xl">
                                ...
                                ?>
                                        <form method="POST" enctype="multipart/form-data" action="<?= base_url('admin/setting/aksi_ubah_foto/').$this->session->userdata('id') ?>">
                                        <div class="form-group">
                                                <label for="exampleInputPassword1">Foto</label>
                                                <?php if($this->session->userdata('foto') != null) { ?>
                                                <img src="<?= base_url() ?>upload/admin/<?= $this->session->userdata('foto') ?>" height="200px" width="300px" alt="Foto Sales">
                                                <?php } ?>
