		...
		<div class="row stats-row">
			<div class="col-lg-4 col-md-12">
				<div class="card card-transparent stats-card">
					<div class="card-body">
						<div class="stats-info">
							<h5 class="card-title">Rp<?= number_format($parsing['penjualan'][0]['nilai'],0,',','.') ?? 0 ?>
							</h5>
							<p class="stats-text">Total Penjualan Keseluruhan</p>
						</div>
			...
			<div class="col-lg-4 col-md-12">
				<div class="card card-transparent stats-card">
					<div class="card-body">
						<div class="stats-info">
							<h5 class="card-title"><?= $parsing['transaksi'][0]['nilai'] ?? 0 ?>
							</h5>
							<p class="stats-text">Total Transaksi Penjualan Keseluruhan</p>
						</div>
			...
			<div class="col-lg-4 col-md-12">
				<div class="card card-transparent stats-card">
					<div class="card-body">
						<div class="stats-info">
							<h5 class="card-title"><?= $parsing['barang'][0]['nilai'] ?? 0 ?>
							</h5>
							<p class="stats-text">Total Penjualan Keseluruhan</p>
						</div>
