                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-barang" role="tabpanel" aria-labelledby="pills-home-tab">
                                ...
                                <br>
                                <a href="<?= base_url('admin/laporan_penjualan/terima/') . $parsing['transaksi'][0]['id_transaksi_sales'] ?>"><button type="button" class="btn btn-info btn-lg btn-block">Terima</button></a>
                                <br>
