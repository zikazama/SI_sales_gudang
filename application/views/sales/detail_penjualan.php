					...
					<div class="card-body">
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-barang" role="tabpanel" aria-labelledby="pills-home-tab">
								...
								<br>
								<a href="<?= base_url('penjualanku/print/') . $parsing['transaksi'][0]['id_transaksi_sales'] ?>"><button type="button" class="btn btn-info btn-lg btn-block">Print</button></a>
								<br>
								<a href="<?= base_url('penjualanku/toko/') . $parsing['transaksi'][0]['id_toko'] ?>"><button type="button" class="btn btn-danger btn-lg btn-block">Kembali</button></a>
							</div>
									...
									<form action="<?= base_url('penjualanku/buat_pembayaran/') . $parsing['transaksi'][0]['id_transaksi_sales'] ?>" method="POST">
										<div class="form-group">
											...
											<div class="input-group-prepend">
												...
												<input name="pembayaran" type="text" class="form-control" id="pembayaran" onkeyup="rupiah(this)" placeholder="Jumlah yang dibayar" value="0" required>

											</div>
										</div>
										<button type="submit" class="btn btn-block btn-primary">Buat Pembayaran</button>
									</form>
								<?php } else { ?>
